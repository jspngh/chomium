...
var PopupController = function () {
    ...
    this.weatherimg_ = document.getElementById('weather-img');
    this.weatherdesc_ = document.getElementById('weather-descr');
    this.weathertemp_ = document.getElementById('weather-temp');
    this.addListeners_();
};
    ...
    handleClick_: function () {
        chrome.storage.local.get('chm-weather', function(result){
            //if (!jQuery.isEmptyObject(result)) {
                ...
                this.weatherimg_.setAttribute('src', "http://openweathermap.org/img/w/"+weather.icon+".png");
                this.weatherdescr_.innerText = weather.main;
                this.weathertemp_.innerText = "temperature: "+weather.temp+" degrees";
                this.button_.setAttribute('disabled', 'disabled');
                this.button_.innerText = 'Testing...';
            //}
        });
    }
};
