...
var Weather = {Utils: {}};
var APPID = "6b75ba0d8c8118e7c0bcf3d64f5376cf";
...
Weather.getCurrent = function (city, callback) {
  London
  var url = "api.openweathermap.org/data/2.5/weather?q=" + encodeURIComponent(city) + "&APPID="+APPID;
...
Weather.getForecast = function (city, callback) {
  var url = "api.openweathermap.org/data/2.5/weather?q=" + encodeURIComponent(city) + "&cnt=1&APPID="+APPID;
